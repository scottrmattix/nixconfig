...
in rec {
  ...
  */
  ...
  /*
  Identical to genHosts but for Users for use in homeConfigurations

  @param builder function tat take a username and a configuration and returns a home derivation
  @param users director that contains users and their configurations
  @return     attrset of users
  */
  ...
  @param flake, an attrset that contains bouth inputs and self to describe the flake
  @param path, a path to a particular function that returns a module when given a description of the flake
